# gratitude-token-project — Public Preview (2025-10-10, archived)
...
This is an **archived** static frontend preview snapshot from **2025-10-10**. It predates a number of fixes and features (routing, mobile stability, the 404 site map, and more) — please use the current preview instead:
